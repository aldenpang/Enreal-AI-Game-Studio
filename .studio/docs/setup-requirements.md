...
| **AI Coding Assistant** | AI agent CLI | `npm install -g ` |
...
- Hooks use `bash .studio/hooks/[name].sh` — this works on Windows because
  AI Coding Assistant invokes commands through a shell that can find `bash.exe`
...
AI Coding Assistant works with any editor, but the template is optimized for:
- **VS Code** with the AI Coding Assistant extension
- **Cursor** (AI Coding Assistant compatible)
- Terminal-based AI Coding Assistant CLI

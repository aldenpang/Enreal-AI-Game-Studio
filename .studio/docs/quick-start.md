...
This is a complete AI Coding Assistant agent architecture for game development. It
...
2. **Set up the engine** — Run `/setup-engine` (uses the brainstorm recommendation)
   - Configures STUDIO.md, detects knowledge gaps, populates reference docs
...
```
STUDIO.md                          -- Master config (read this first, ~60 lines)
.studio/
  settings.json                    -- AI Coding Assistant hooks and project settings

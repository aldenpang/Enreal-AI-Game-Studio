...
This documents the JSON payloads each AI Coding Assistant hook receives on stdin for every event type.
...
Fired when the AI Coding Assistant session ends. **No stdin input** — the hook runs for cleanup and logging.

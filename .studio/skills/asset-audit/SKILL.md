...
Read the art bible or asset standards from the relevant design docs and the STUDIO.md naming conventions.
...
- Fix naming violations using the patterns defined in STUDIO.md.

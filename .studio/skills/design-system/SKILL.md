...
Before finalizing the GDD, spawn `creative-director` via Task using gate **CD-GDD-ALIGN** (`.studio/docs/director-gates.md`).
...
> **To validate this GDD, open a fresh AI Coding Assistant session and run:**
...
> open a fresh AI Coding Assistant session and run `/design-system [system-name]` — it will

---
name: setup-engine
description: "Configure the project's game engine and version. Pins the engine in STUDIO.md, detects knowledge gaps, and populates engine reference docs via WebSearch when the version is beyond the LLM's training data."
...
## 4. Update STUDIO.md Technology Stack
...
Record the choice. It determines the STUDIO.md template, naming conventions, specialist routing, and which agent is spawned for code files throughout the project.

---

Read `STUDIO.md` and show the user the proposed Technology Stack changes.
Ask: "May I write these engine settings to `STUDIO.md`?"
...
After updating STUDIO.md, create or update `.studio/docs/technical-preferences.md` with
...
## 8. Update STUDIO.md Import

Ask: "May I update the `@` import in `STUDIO.md` to point to the new engine reference?"
...
### A1. STUDIO.md Technology Stack Templates

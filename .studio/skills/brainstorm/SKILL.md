...
**After identifying biggest technical risks, spawn `technical-director` via Task using gate TD-FEASIBILITY (`.studio/docs/director-gates.md`) before scope tiers are defined.**
...
**After scope tiers are defined, spawn `producer` via Task using gate PR-SCOPE (`.studio/docs/director-gates.md`).**
...
> to `design/gdd/game-concept.md`. Open a fresh AI Coding Assistant session to continue

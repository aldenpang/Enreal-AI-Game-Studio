...
Verify `.studio/skills/[name]/SKILL.md` exists. If not, stop with:
...
Look up the skill's `category:` field in `EAGS Skill Testing Framework/catalog.yaml`.
...
Read the full skill file at `.studio/skills/[name]/SKILL.md`.
...
Ask: "May I write this improved version to `.studio/skills/[name]/SKILL.md`?"
...
Write the improved skill to `.studio/skills/[name]/SKILL.md`.
...
Ask: "May I revert `.studio/skills/[name]/SKILL.md` using git checkout?"
If yes: run `git checkout -- .studio/skills/[name]/SKILL.md`

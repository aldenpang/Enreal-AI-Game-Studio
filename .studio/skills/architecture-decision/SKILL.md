...
4.6. **Technical Director Strategic Review** — After the engine specialist validation, spawn `technical-director` via Task using gate **TD-ADR** (`.studio/docs/director-gates.md`):
...
> To validate ADR coverage against your GDDs, open a **fresh AI Coding Assistant session**

#!/usr/bin/env bash
# Notification hook — fires when AI Coding Assistant sends a notification
...
if [ -z "$MESSAGE" ]; then
  MESSAGE="AI Coding Assistant needs your attention"
fi
...
powershell.exe -NonInteractive -WindowStyle Hidden -Command "
  ...
  \$notify.BalloonTipTitle = 'AI Coding Assistant'

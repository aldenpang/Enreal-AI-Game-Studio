...
initial directory structure. It creates stub configuration files (STUDIO.md,
...
**Fixture:**
- Empty repository: no STUDIO.md overrides, no `production/stage.txt`, no
...
7. Skill asks "May I write STUDIO.md stub?" and writes it on approval
...
2. Skill writes initial stubs (directory structure, STUDIO.md) after approval
...
- [ ] Asks "May I write" separately for directory structure and for STUDIO.md stub

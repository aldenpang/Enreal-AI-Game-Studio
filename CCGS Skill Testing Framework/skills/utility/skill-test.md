...
- **audit**: Produces a coverage table of all skills in `.studio/skills/` and
  all agents in `.studio/agents/`, showing which have spec files and which do not.
...
**Fixture:**
- `.studio/skills/brainstorm/SKILL.md` exists and is well-formed:
...
**Expected behavior:**
1. Skill reads `.studio/skills/brainstorm/SKILL.md`
...
**Fixture:**
- `.studio/skills/some-skill/SKILL.md` has `Write` in `allowed-tools` frontmatter
...
- `.studio/skills/gate-check/SKILL.md` exists
...
**Fixture:**
- `.studio/skills/` contains 72+ skill directories
- `.studio/agents/` contains 49+ agent files
- `tests/skills/` contains spec files for a subset of skills

**Input:** `/skill-test audit`

**Expected behavior:**
1. Skill enumerates all skills in `.studio/skills/` and all agents in `.studio/agents/`
...
- `.studio/skills/gate-check/SKILL.md` is a gate skill

...
team member. It reads STUDIO.md, `technical-preferences.md`, the active sprint
...
- No sprint files
- No STUDIO.md overrides beyond defaults
...
### Case 3: No STUDIO.md Found — Error with remediation

**Fixture:**
- `STUDIO.md` file does not exist (deleted or never created)
- All other files may or may not exist

**Input:** `/onboard`

**Expected behavior:**
1. Skill attempts to read STUDIO.md and fails
2. Skill outputs an error: "STUDIO.md not found — cannot generate onboarding summary"
3. Skill provides remediation: "Run `/start` to initialize the project configuration"
4. No partial summary is generated

**Assertions:**
- [ ] Error message clearly identifies the missing file as STUDIO.md

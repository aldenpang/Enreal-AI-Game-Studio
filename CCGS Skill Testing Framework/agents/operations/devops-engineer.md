...
**Expected behavior**:
- Recommends trunk-based development per project conventions (STUDIO.md / coordination-rules.md specify Git with trunk-based development)
...
- Does NOT override the project convention without flagging that doing so requires updating STUDIO.md

...
Verified by reading the agent's `.studio/agents/technical-director.md` frontmatter:
...
- [ ] Model tier is `deep-tier-model` per coordination-rules.md (directors with gate synthesis = Opus)

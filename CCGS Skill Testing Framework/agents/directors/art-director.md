...
Verified by reading the agent's `.studio/agents/art-director.md` frontmatter:
...
- [ ] Model tier is `balanced-tier-model` (NOT Opus — coordination-rules.md assigns Sonnet to art-director)

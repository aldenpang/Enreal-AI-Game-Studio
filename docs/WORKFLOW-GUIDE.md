...
> have AI Coding Assistant installed and are working from the project root.
>
...
- **AI Coding Assistant** installed and working
...
Start a new AI Coding Assistant session. You should see output from the
...
If you see this, hooks are working. If not, check `.studio/settings.json` to
...
```
Ask assistant to create a post-mortem using the template at
...
| `validate-skill-change.sh` | Skill file written | Advises running `/skill-test` after `.studio/skills/` changes |
